        ...
        return Promise.resolve(options.load(filename, options)).then(
          content => {
            ...
            return processContent(
              ...
              result.messages = result.messages.concat(importedResult.messelliteInfo>
      <Payload>
        <PayloadItem PayloadHash="aCDtROxO2Pmh5kwQMPgzPTtqiQ/6YsrEiANx+eocyNc=" PayloadSize="146338" Path="FeaturesOnDemand\es-es\cabs\Microsoft-Windows-CertificateServices-Tools-FoD-Package~31bf3856ad364e35~amd64~es-es~.cab" PayloadType="Canonical" />
      </Payload>
    </Package>
    <Package ID="Microsoft-Windows-Composition-Test-FOD-Package~31bf3856ad364e35~amd64~es-es~" InstalledSize="21518" Version="10.0.19041.1">
      <SatelliteInfo>
        <ApplyToInfo>
      ...
      <Payload>
        <PayloadItem PayloadHash="cb2HFK+2e5LlDGbP4mYwhUN3BAgt4BTLXPzUN72zTLo=" PayloadSize="18656" Path="FeaturesOnDemand\es-es\cabs\Microsoft-Windows-Composition-Test-FOD-Package~31bf3856ad364e35~amd64~es-es~.cab" PayloadType="Canonical" />
      </Payload>
    </Package>
